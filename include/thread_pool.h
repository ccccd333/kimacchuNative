...
public:
    ...
    ui32 thread_count() const { return thread_count_; }
...
private:
     ...
     *
     *  Continuously pops tasks out of the queue and executes them, as long as the atomic variable running is set to
     * true.
     */
    void worker() {
        for (;;) {
