//#pragma once
//
//#include "KMCJCInterface.h"
//#include "IWWFunctions.h"
//
//namespace KMCCT {
//    template <class F>
//    void get_class_function(const reflection_interface* refl, const char* a_funcName, const char* a_className,
//                            F& a_func) {
//        a_func = reinterpret_cast<F>(refl->tes_function_of_class(a_funcName, a_className));
//        if (!a_func) {
//            ERROR("kimachuu: couldn't obtain function {}::{}", a_className, a_funcName);
//        } else {
//            LOG("kimachuu: found function {}::{}", a_className, a_funcName);
//        }
//    }
//
//    class JCWrapper {
//        SINGLETONHEADER(JCWrapper)
//    private:
//        const root_interface* ri = nullptr;
//
//    public:
//        void PreInit(const root_interface* a_root);
//        void Init();
//    };
//
...
//    inline RE::TESForm* (*jmap_get_form_func)(void*, int32_t a_obj, RE::BSFixedString a_key,
...
//    inline RE::BSFixedString (*jmap_get_str_func)(void*, int32_t a_obj, RE::BSFixedString a_key,
//                                                  RE::BSFixedString a_default) = nullptr;
...
//    inline void (*jmap_set_str_func)(void*, int32_t a_obj, RE::BSFixedString a_key,
//                                     RE::BSFixedString a_value) = nullptr;
...
//    inline int32_t (*jarray_find_int_func)(void*, int32_t a_arr, int32_t a_value,
//                                           int32_t a_search_startindex) = nullptr;
//    inline int32_t (*jarray_find_obj_func)(void*, int32_t a_arr, int32_t a_container,
//                                           int32_t a_search_startindex) = nullptr;
...
//    inline RE::BSFixedString (*jarray_get_str_func)(void*, int32_t a_obj, int32_t a_index,
//                                                    RE::BSFixedString a_default) = nullptr;
...
//    inline bool (*jdb_solve_obj_setter_func)(void*, RE::BSFixedString a_path, int32_t a_obj,
//                                             bool a_create_missing_keys) = nullptr;
...
//    inline void (*jformdb_set_entry_func)(void*, RE::BSFixedString a_storage_name, RE::TESForm* a_fKey,
//                                          int32_t a_entry) = nullptr;
//    inline void (*jformdb_set_int_func)(void*, RE::TESForm* a_fKey, RE::BSFixedString a_key, int32_t a_value) = nullptr;
//    inline void (*jformdb_set_obj_func)(void*, RE::TESForm* a_fKey, RE::BSFixedString a_key,
//                                        int32_t a_container) = nullptr;
//    inline void (*jformdb_set_str_func)(void*, RE::TESForm* a_fKey, RE::BSFixedString a_key,
//                                        RE::BSFixedString a_value) = nullptr;
//
//    // JAtomic
...
//    inline int32_t (*jatomic_compare_exchange_int_func)(void*, int32_t a_obj, RE::BSFixedString a_path,
//                                                        int32_t a_desired, int32_t a_expected,
//                                                        bool a_create_missing_keys,
//                                                        int32_t a_result_on_error) = nullptr;
//
//    // JContainers
...
//            return jmap_get_form_func ? jmap_get_form_func(jc_default_domain, a_obj, a_key, a_default = nullptr)
//                                      : nullptr;
//        }
...
//        }
//        static inline RE::BSFixedString getStr(int32_t a_obj, RE::BSFixedString a_key,
...
//        }
//        static inline int object() { return jmap_object_func ? jmap_object_func(jc_default_domain) : 0; }
//        static inline RE::BSFixedString nextKey(int32_t a_obj, RE::BSFixedString a_previous_key = "",
//                                                RE::BSFixedString a_end_key = "") {
//            return jmap_next_key_func ? jmap_next_key_func(jc_default_domain, a_obj, a_previous_key, a_end_key)
//                                      : a_end_key;
//        }
//        static inline void setFlt(int32_t a_obj, RE::BSFixedString a_key, float a_value) {
//            if (jmap_set_flt_func) jmap_set_flt_func(jc_default_domain, a_obj, a_key, a_value);
//        }
//        static inline void setInt(int32_t a_obj, RE::BSFixedString a_key, int32_t a_value) {
//            if (jmap_set_int_func) jmap_set_int_func(jc_default_domain, a_obj, a_key, a_value);
//        }
//        static inline void setObj(int32_t a_obj, RE::BSFixedString a_key, int32_t a_value) {
//            if (jmap_set_obj_func) jmap_set_obj_func(jc_default_domain, a_obj, a_key, a_value);
//        }
//        static inline void setStr(int32_t a_obj, RE::BSFixedString a_key, RE::BSFixedString a_value) {
//            if (jmap_set_str_func) jmap_set_str_func(jc_default_domain, a_obj, a_key, a_value);
//        }
...
//            if (jarray_add_obj_func) jarray_add_obj_func(jc_default_domain, a_arr, a_obj, a_index);
//        }
//        static inline void addInt(int32_t a_arr, int32_t a_int, int32_t a_index = -1) {
//            if (jarray_add_int_func) jarray_add_int_func(jc_default_domain, a_arr, a_int, a_index);
//        }
//        static inline void clear(int32_t a_obj) {
//            if (jarray_clear_func) jarray_clear_func(jc_default_domain, a_obj);
//        }
//        static inline int count(int32_t a_obj) {
...
//            if (jarray_erase_index_func) jarray_erase_index_func(jc_default_domain, a_arr, a_index);
//        }
//        static inline int findInt(int32_t a_arr, int32_t a_value, int32_t a_search_start_index = 0) {
//            return jarray_find_int_func ? jarray_find_int_func(jc_default_domain, a_arr, a_value, a_search_start_index)
//                                        : 0;
//        }
//        static inline int findObj(int32_t a_arr, int32_t a_container, int32_t a_search_start_index = 0) {
//            return jarray_find_obj_func
//                       ? jarray_find_obj_func(jc_default_domain, a_arr, a_container, a_search_start_index)
//                       : 0;
//        }
...
//        }
//        static inline int object() { return jarray_object_func ? jarray_object_func(jc_default_domain) : 0; }
...
//            if (jvalue_clean_pool_func) jvalue_clean_pool_func(jc_default_domain, a_pool_name);
//        }
...
//            if (jvalue_write_to_file_func) jvalue_write_to_file_func(jc_default_domain, a_obj, a_file_path);
//        }
//    };
//
//    class JDB {
...
//            return jdb_solve_obj_setter_func
//                       ? jdb_solve_obj_setter_func(jc_default_domain, a_path, a_obj, a_create_missing_keys)
//                       : 0;
//        }
//        static inline void setObj(RE::BSFixedString a_path, int32_t a_obj) {
//            if (jdb_set_obj_func) jdb_set_obj_func(jc_default_domain, a_path, a_obj);
//        }
//        static inline int32_t root() { return jdb_root_func ? jdb_root_func(jc_default_domain) : 0; }
//    };
//
//    class JFormDB {
//    public:
...
//            if (jformdb_set_entry_func) jformdb_set_entry_func(jc_default_domain, a_storage_name, a_fKey, a_entry);
//        }
//        static inline void setInt(RE::TESForm* a_fKey, RE::BSFixedString a_key, int32_t a_value) {
//            if (jformdb_set_int_func) jformdb_set_int_func(jc_default_domain, a_fKey, a_key, a_value);
//        }
//        static inline void setObj(RE::TESForm* a_fKey, RE::BSFixedString a_key, int32_t a_container) {
//            if (jformdb_set_obj_func) jformdb_set_obj_func(jc_default_domain, a_fKey, a_key, a_container);
//        }
//        static inline void setStr(RE::TESForm* a_fKey, RE::BSFixedString a_key, RE::BSFixedString a_value) {
//            if (jformdb_set_str_func) jformdb_set_str_func(jc_default_domain, a_fKey, a_key, a_value);
//        }
//    };
//
//    class JAtomic {
//    public:
//        static inline int32_t compareExchangeInt(int32_t a_obj, RE::BSFixedString a_path, int32_t a_desired,
//                                                 int32_t a_expected, bool a_create_missing_keys,
//                                                 int32_t a_result_on_error) {
...
//                       : 0;
//        }
//        static inline int32_t fetchAddInt(int32_t a_obj, RE::BSFixedString a_path, int32_t a_value,
//                                          int32_t a_initial_value, bool a_create_missing_keys,
//                                          int32_t a_result_on_error) {
...
//            return jcontainers_file_exists_at_path_func
//                       ? jcontainers_file_exists_at_path_func(jc_default_domain, a_path)
//                       : false;
//        }
//    };
//
