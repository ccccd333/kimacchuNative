//#include "KMCJCWrapper.h"
//
//
//SINGLETONBODY(KMCCT::JCWrapper)
//
//namespace KMCCT {
//
//    void JCWrapper::PreInit(const root_interface* a_root) { ri = a_root; }
//
//    void JCWrapper::Init() {
//        if (!ri) {
//            LOG("JCWrapper::Init(): JContainers root interface not set.");
//            std::abort();
//        }
//        LOG("JCWrapper::Init() started");
//
//        auto refl = ri->query_interface<reflection_interface>();
//        LOG("query_interface<jc::reflection_interface>: refl = {}", (void*)refl);
//        if (!refl) {
//            LOG("JCWrapper::Init(): Could not get JContainers reflection interface.");
//            std::abort();
//        }
//
//        auto dom = ri->query_interface<domain_interface>();
//        LOG("query_interface<jc::domain_interface>: dom = {}", (void*)dom);
//        if (!dom) {
//            LOG("JCWrapper::Init(): Could not get JContainers domain interface.");
//            std::abort();
//        }
//
//        jc_default_domain = dom->get_default_domain();
//        LOG("dom->get_default_domain(): default_domain = {}", (void*)jc_default_domain);
//        if (!jc_default_domain) {
//            LOG("JCWrapper::Init(): Could not get JContainers default domain.");
//            std::abort();
//        }
//
//        // JMap
//        get_class_function(refl, "allKeys", "JMap", jmap_all_keys_func);
//        LOG("After get_class_function(allKeys, JMap)");
